...
- **Install Tabs Widget**: Add this to your webpage's body wherever you'd like display a Tabs Widget.
```html
...
- **Install Table Widget**: Add this to your webpage's body wherever you'd like display a Table Widget.
```html
